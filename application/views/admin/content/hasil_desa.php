<link href="<?php echo base_url('assets/bootstrap/css/bootstrap.min.css')?>" rel="stylesheet">
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Hasil Desa</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
 ...
 <section class="container-fluid" style="overflow-y: auto; overflow-x: scroll;">
    <div class="dropdown">
        <a href="<?php echo site_url() ?>/admin_controller/tambah_hasil_desa" style="float: left; margin-bottom: 10px;"
                            ...
                            <div class="col-md-12">
                                <section class="content">
                                    <div class="row">
                                        <div class="box">
                                            <div class="box-header">
                                                <h3 class="box-title">Edit isinya
                                                </h3>
