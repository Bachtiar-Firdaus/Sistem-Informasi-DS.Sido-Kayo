...
<link href="<?php echo base_url('assets/bootstrap-datepicker/css/bootstrap-datepicker3.min.css')?>" rel="stylesheet">
      <!--  content -->
        <div class="content-wrapper">
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">REKAP ORDER</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
            ...
            <?php echo form_open_multipart('admin_controller/cetak_order', array('role'=>'form'));
                        if(isset($message)): 
                        echo "<div class='alert alert-success ggg action='post'><b>".$message."</b></div>";
                        endif; ?>   
                <div class="form-group">
                    ...
                    <div class="input-group date">
                        ...
                        <input type="date" name="tanggal1" class="form-control pull-right" >
                    </div>
                <div class="form-group">
                    <label>Date:</label>
                    <div class="input-group date">
                        ...
                        <input type="date" name="tanggal2" class="form-control pull-right" >
                    </div>
